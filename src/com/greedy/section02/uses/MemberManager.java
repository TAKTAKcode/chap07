...
public class MemberManager {
	...
	public void signUpMembers() {
		...
		MemberRegistManager memberRegistManager = new MemberRegistManager();
		memberRegistManager.regist(members);
	}
	
	public void printAllMembers() {
		
//		MemberSelectManager memberSelectedManager = new MemberSelectManager();
//		MemberDTO[] selectedMembers = memberSelectedManager.selectAllMember();
		
		MemberDTO[] selectedMembers = new MemberSelectManager().selectAllMember();
